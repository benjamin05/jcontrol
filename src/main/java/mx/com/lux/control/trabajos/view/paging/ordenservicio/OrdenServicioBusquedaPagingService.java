...
public class OrdenServicioBusquedaPagingService implements PagingService<Jb> {
	 ...
	 * @param cliente
	 */
	public OrdenServicioBusquedaPagingService( OrdenServicioService service, String orden, String cliente ) {
		super();
	...
	public List<Jb> getPage( int firstResult, int resultSize ) throws ApplicationException {
		return service.findJbByOrden( orden, cliente, firstResult, resultSize );
	}

	@Override
	public int count() throws ApplicationException {
		return service.countJbByOrden( orden, cliente );
	}
